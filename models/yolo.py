...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg", type=str, default="/home/gxu4090x2/桌面/lqh/program/DPE-YOLO/models/yolov5s-ELFN-PEM-DPFE.yaml", help="model.yaml")
