...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "/home/gxu4090x2/桌面/lqh/program/RTDETR-main/dataset/AI-TOD/AI-TOD.yaml", help="dataset.yaml path")
    ...
    parser.add_argument("--project", default=ROOT / "runs/val/ai-tod", help="save to project/name")
