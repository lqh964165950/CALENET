...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "/home/gxu4090x2/桌面/lqh/program/RTDETR-main/dataset/VisDrone/VisDrone.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=ROOT / "/home/gxu4090x2/桌面/lqh/program/yolov5-master1/data/hyps/hyp.scratch-low.yaml", help="hyperparameters path")
